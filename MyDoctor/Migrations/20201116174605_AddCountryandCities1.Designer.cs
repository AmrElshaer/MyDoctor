...
namespace MyDoctor.Migrations
{
    ...
    [Migration("20201116174605_AddCountryandCities1")]
    partial class AddCountryandCities1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyDoctor.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyDoctor.Models.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyDoctor.Models.City", b =>
                {
                    b.HasOne("MyDoctor.Models.Country", "Country")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("MyDoctor.Models.Doctor", b =>
                {
                    b.HasOne("MyDoctor.Models.BeatyandHealthy", "Category")
                        .WithMany("Doctors")
