...
{
    public partial class InitMyDoctorInfrastructure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastUpdateSee = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BeatyandHealthyId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BeatyandHealthyId = table.Column<int>(type: "int", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModiteDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BeatyandHealthId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "f2fffca5-d5be-43ad-ae22-4ce78eb2b2d8", "Admin", "Admin" },
                    { "2", "dbcbc154-e9f5-475c-8439-3a29ed5ceef2", "Client", "Client" },
                    { "3", "10275bc0-010d-4ada-a0a9-366d0f02eb62", "Doctor", "Doctor" },
                    { "4", "e489d549-b81a-479b-9677-44b79f85c797", "CreatePost", "CreatePost" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "d68bc05c-e302-4ad3-879b-bcf85ff9f914", "Admin@Admin.com", false, null, true, null, "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAEAACcQAAAAEPmKZBa1N5pVVTehHguIfSZ4R61umgmV0v2PlKhS1kV6D9Hn7OW2Tbd3PJkcw7dK3g==", null, false, "c01ddf4a-1edd-4609-b740-badad047a185", false, "Admin@Admin.com" });
