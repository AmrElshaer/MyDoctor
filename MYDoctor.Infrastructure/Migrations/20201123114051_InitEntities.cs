        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BeatyandHealthyId = table.Column<int>(nullable: false),
                    CreateDate = table.Column<DateTime>(nullable: true),
                    ModifiedDate = table.Column<DateTime>(nullable: true),
                    Image = table.Column<string>(nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateDate = table.Column<DateTime>(nullable: true),
                    ModiteDate = table.Column<DateTime>(nullable: true),
                    BeatyandHealthId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelativeofBeatyandhealthy", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RelativeofBeatyandhealthy_BeatyandHealthy_BeatyandHealthId",
                        column: x => x.BeatyandHealthId,
                        principalTable: "BeatyandHealthy",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiseaseMedicins", x => new { x.DiseaseId, x.MedicinId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "65d48e0d-6012-4b8a-a2aa-c9adea01d00b", "Admin", "Admin" },
                    { "2", "c39e351f-a679-4149-8b15-66c6e5cd7a30", "Client", "Client" },
                    { "3", "a1d2e550-12ad-4149-a8de-ced6b3edddec", "Doctor", "Doctor" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "1f016841-ed26-46f4-b227-8df6a34d3192", "Admin@Admin.com", true, null, false, null, null, null, "AQAAAAEAACcQAAAAEJWGsjcOukXm4fn6LajwQWvNJyTqhaXSPx7blRYCCoFKagoZj5jPQrbjL6hcu473Tw==", null, false, null, false, "Admin@Admin.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelativeofBeatyandhealthy_BeatyandHealthId",
                table: "RelativeofBeatyandhealthy",
                column: "BeatyandHealthId");
        }
